...
![Overview](/assets/img/posts/31/1.png){: w="420" h = "370"}
...
![Overview](/assets/img/posts/31/2.png){: w="440" h = "380"}
*Model Overview*

![Example](/assets/img/posts/31/3.png){: w="440" h = "350"}
*Duck wants to subscribe*

![Example](/assets/img/posts/31/4.png){: w="400" h = "350"}
*Duck is now an observer, too*

![Example](/assets/img/posts/31/5.png){: w="400" h = "350"}
*Notifying the observers*

![Example](/assets/img/posts/31/6.png){: w="400" h = "350"}
*Mouse wants to unsubscribe*

![Example](/assets/img/posts/31/7.png){: w="410" h = "350"}
*Notifying the observers*

### The Observer Pattern Defined
* The Observer Pattern defines a **one-to-many dependency** between objects so that when one object changes state, all of its dependents are notified and updated automatically.

![Example](/assets/img/posts/31/8.png){: w="440" h = "360"}

### Class Diagram for Observer Pattern

![Diagram](/assets/img/posts/31/9.png){: w="380" h = "360"}
...
![Diagram](/assets/img/posts/31/10.png){: w="450" h = "390"}
...
![Diagram](/assets/img/posts/31/11.png){: w="450" h = "390"}
