...
* e.g. to find all courses taught in the Fall 2017 semester, or in the Spring 2018 semester, or in both
    * $\Pi_{course_id}(\sigma_{semester = "Fall" \wedge year = 2017}(section)) \cup \Pi_{course \_ id}(\sigma_{semester = "Spring" \wedge year = 2018}(section))$
...
* e.g. Find information about courses taught by instructors in the Physics department.
    ...
    * $(\sigma_{dept\class{mathjaxCursor}{\text{_}} name = "Physics"}(instructor)) \Join_{instructor.ID = teaches.ID} teaches$
