...
* e.g. select those tuples of the *instructor* relation where the instructor is in the “Physics” department.
    * $\sigma_{dept\char95 name = "Physics"}(instructor)$
...
* We can combine several predicates into a larger predicate by using the connectives.
    ...
    * e.g. find the instructors in Physics with a salary greater $90,000
        * $\sigma_{dept \textunderscore name = "Physics" \wedge salary > 90000}(instructor)$
* The select predicate may  include comparisons between two attributes.
    * e.g. find all departments whose name is the same as their building name
        * $\sigma_{dept \textunderscore name = building}(department)$
...
* e.g. find the names of all instructors in the Physics department.
    * $\Pi_{name}(\sigma_{dept \textunderscore name = "Physics"}(instructor))$
...
![Result](/assets/img/posts/27/7.png){: w="420" h = "360"}
*Result*
...
* e.g. to find all courses taught in the Fall 2017 semester, or in the Spring 2018 semester, or in both
    * $\Pi_{course_id}(\sigma_{semester = "Fall" \wedge year = 2017}(section)) \cup \Pi_{course \textunderscore id}(\sigma_{semester = "Spring" \wedge year = 2018}(section))$

![Result](/assets/img/posts/27/8.png){: w="300" h = "360"}
*Result*
...
* e.g. Find the set of all courses taught in both the Fall 2017 and the Spring 2018 semesters.
    * $\Pi_{course \textunderscore id}(\sigma_{semester = "Fall" \wedge year = 2017}(section)) \cap \Pi_{course \textunderscore id}(\sigma_{semester = "Spring" \wedge year = 2018}(section))$

![Result](/assets/img/posts/27/9.png){: w="300" h = "280"}
*Result*
...
* e.g. to find all courses taught in the Fall 2017 semester, but not in the Spring 2018 semester.
    * $\Pi_{course \textunderscore id}(\sigma_{semester = "Fall" \wedge year = 2017}(section)) - \Pi_{course \textunderscore id}(\sigma_{semester = "Spring" \wedge year = 2018}(section))$

![Result](/assets/img/posts/27/10.png){: w="300" h = "280"}
*Result*
...
* e.g. Find all instructor in the “Physics” and Music department.
    * $Physics \leftarrow \sigma_{dept \textunderscore name = "Physics"}(instructor)$
    * $Music \leftarrow \sigma_{dept \textunderscore name = "Music"}(instructor)$
    * $Physics \cup Music$
...
* e.g. Find information about courses taught by instructors in the Physics department with salary greater than 90,000.
    * $\sigma_{dept \textunderscore name = "Physics" \wedge salary > 90000}(instructor)$
    * $sigma_{dept \textunderscore name = "Physics"}(sigma_{salary > 90000}(instructor))$
* e.g. Find information about courses taught by instructors in the Physics department.
    * $sigma_{dept \textunderscore name = "Physics"}(instructor \Join_{instructor.ID = teaches.ID} teaches)$
    * $(\sigma_{dept \textunderscore name = "Physics"}(instructor)) \Join_{instructor.ID = teaches.ID} teaches$
