...
![diagram](/assets/img/posts/36/1.png){: w="380" h = "340"}
...
![diagram](/assets/img/posts/36/2.png){: w="380" h = "370"}

### Class Diagram for Abstract Factory Pattern
![diagram](/assets/img/posts/36/3.png){: w="370" h = "350"}
...
![diagram](/assets/img/posts/36/4.png){: w="360" h = "390"}
*Supporting new kinds of products is difficult (not impossible, but costly)*


![diagram](/assets/img/posts/36/5.png){: w="370" h = "350"}
