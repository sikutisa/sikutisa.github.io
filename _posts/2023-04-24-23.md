...
![HDD](/assets/img/posts/23/1.png){: w="330" h = "320"}
...
![FIFO](/assets/img/posts/23/2.png){: w="360" h = "320"}
...
![SCAN](/assets/img/posts/23/3.png){: w="360" h = "320"}
...
![C-SCAN](/assets/img/posts/23/4.png){: w="360" h = "320"}
...
![Boot](/assets/img/posts/23/5.png){: w="320" h = "300"}
...
![RAID](/assets/img/posts/23/6.png){: w="420" h = "350"}
*RAID levels*

![RAID](/assets/img/posts/23/7.png){: w="340" h = "380"}
...
![IO](/assets/img/posts/23/8.png){: w="400" h = "370"}
...
![port](/assets/img/posts/23/9.png){: w="320" h = "300"}
...
![Interrupt](/assets/img/posts/23/10.png){: w="320" h = "360"}
*Interrupt-driven I/O cycle*

![Interrupt](/assets/img/posts/23/11.png){: w="320" h = "340"}
*Intel Pentium processor event-vector table*

![DMA](/assets/img/posts/23/12.png){: w="360" h = "360"}
...
![Models](/assets/img/posts/23/13.png){: w="370" h = "340"}
...
![Seq](/assets/img/posts/23/14.png){: w="310" h = "240"}
*Sequential-access file*

![Dir](/assets/img/posts/23/15.png){: w="310" h = "280"}
...
![Single](/assets/img/posts/23/16.png){: w="350" h = "250"}
*Single-level directory*

![Two](/assets/img/posts/23/17.png){: w="370" h = "300"}
*Two-level directory*

![Tree](/assets/img/posts/23/18.png){: w="380" h = "370"}
*Tree-structured directory structure*

![Acyclic](/assets/img/posts/23/19.png){: w="340" h = "340"}
*Acyclic-graph directory structure*

![General](/assets/img/posts/23/20.png){: w="350" h = "340"}
*General graph directory*

## File-System Implementation
* The file system itself is generally composed of many different levels.

![Layer](/assets/img/posts/23/21.png){: w="240" h = "300"}
*Layered file system*
...
![Contiguous](/assets/img/posts/23/22.png){: w="350" h = "370"}
...
![Linked](/assets/img/posts/23/23.png){: w="350" h = "370"}
...
![FAT](/assets/img/posts/23/24.png){: w="330" h = "350"}
...
![Indexed](/assets/img/posts/23/25.png){: w="350" h = "370"}
*Indexed allocation of disk space*

### Free-Space Management
* To keep track of free disk space, the system maintains a *free-space list*.

![Free](/assets/img/posts/23/26.png){: w="330" h = "370"}
