---
title: Operating System Intorduction(1)
author: <author_id>
...
![Computer System](/assets/img/posts/2/3.png){: w="420" h = "400"}
*_Abstract view of the components of a computer system_*
...
![Typical PC](/assets/img/posts/2/4.png){: w="500" h = "380"}
*_A typical PC computer system_*
...
![Interrupts](/assets/img/posts/2/5.png){: w="520" h = "380"}
*_Interrupt timeline for a single program doing output_*
...
![Memory Hierarchy](/assets/img/posts/2/6.png){: w="440" h = "480"}
*_Storage-device hierarchy_*

## I/O Structure
A large portion of OS code is dedicated to managing I/O

![Computer System](/assets/img/posts/2/7.png){: w="400" h = "400"}
*_How a modern computer system works_*
...
![SMP](/assets/img/posts/2/8.png){: w="400" h = "300"}
*_Symmetric multiprocessing architecture_*

## Multi-core design
* With several cores on the same processor chip.

![Multi-core](/assets/img/posts/2/9.png){: w="360" h = "300"}
...
![Multiprogramming](/assets/img/posts/2/10.png){: w="300" h = "420"}
*_Memory layout for a multiprogramming system_*
...
![User mode & Kernel mode](/assets/img/posts/2/11.png){: w="460" h = "320"}
*_Transition from user to kernel mode_*
...
![Virtualization](/assets/img/posts/2/12.png){: w="480" h = "400"}
*_A computer running (a) a single operating system and (b) three virtual machines_*