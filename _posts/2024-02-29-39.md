---
title: Annotation @Inheritance(strategy=JOINED)와 @MapperSuperClass
author: <author_id>
date: 2024-02-29 00:29:00 +0900
categories: [SpringFramework, SpringDataJpa]
...
## Overview
### ERD
![ERD](/assets/img/posts/39/1.png){: w="380" h = "300"}

### 의문점
* @Inheritance(strategy=JOINED)와 @MapperSuperClass를 사용했을 때, 각각에 대해
    * 물리적인 테이블이 어떻게 생성되는가?
...
* 테이블
    ...
    ![table](/assets/img/posts/39/2.png){: w="280" h = "320"}
...
* 테이블 별 데이터
    * ITEM 테이블
    ...
    ![item](/assets/img/posts/39/3.png){: w="310" h = "270"}
    
    * BACKGROUND 테이블
    
    ![background](/assets/img/posts/39/4.png){: w="300" h = "250"}
    
    * PROP 테이블
    
    ![prop](/assets/img/posts/39/5.png){: w="300" h = "250"}
    
    * 자식 테이블은 부모 테이블의 PK를 FK로 들고 있음

## @MapperSuperClass의 테이블 생성
### Entity Code
```java
package com.example.jpatest.entity;
...
* 테이블
    ...
    ![table](/assets/img/posts/39/6.png){: w="280" h = "320"}
...
* 테이블 별 데이터
    * BACKGROUND 테이블
    ...
    ![background](/assets/img/posts/39/7.png){: w="340" h = "250"}

    * PROP 테이블
    
    ![prop](/assets/img/posts/39/8.png){: w="330" h = "250"}
...
## See Also
* https://docs.jboss.org/hibernate/orm/6.4/introduction/html_single/Hibernate_Introduction.html#mapping-inheritance
* https://docs.jboss.org/hibernate/orm/6.4/querylanguage/html_single/Hibernate_Query_Language.html#function-treat