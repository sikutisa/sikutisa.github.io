...
![hw](/assets/img/posts/34/1.png){: w="360" h = "360"}

### Our Vendor Classes
![vendor](/assets/img/posts/34/2.png){: w="380" h = "380"}
...
### Our Approach
![approach](/assets/img/posts/34/3.png){: w="380" h = "400"}

* **Encapsulates a request as an object**
    * Thus, let you parameterize clients with different requests, queue or log requests, and support undoable operations.

![uml](/assets/img/posts/34/4.png){: w="360" h = "340"}

### Collaborations
![coll](/assets/img/posts/34/5.png){: w="380" h = "330"}
...
![after](/assets/img/posts/34/6.png){: w="360" h = "360"}
...
![diagram](/assets/img/posts/34/7.png){: w="370" h = "340"}
